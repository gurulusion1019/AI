...
def _build_file_path_partition(meta: "FileMeta", file_path: str) -> dict:
    ...
    if ext in (".xlsx", ".xls"):
        m_expr = [
            ...
            "    Result = Table.TransformColumnTypes(Headers,",
    ...
    logger.info("Parameter M query for %s -> SourceDataFolder/%s", meta.table_name, fname)
    return {
...
def build_pbip_files(model: SemanticModel, bim_str: str, report_str: str) -> dict:
    ...
    files = {
        ...
        f"{report_folder}/report.json": report_str,
